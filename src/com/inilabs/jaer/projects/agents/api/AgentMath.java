...
import com.inilabs.jaer.projects.agents.api.Agent3DTypes.AzElDist;

public final class AgentMath {
    private AgentMath(){}

    public static Agent3DTypes.AzElDist azElDistFromDVX(Space3D.Vec3 ref, Space3D.Vec3 pos){
        ...
        return new Agent3DTypes.AzElDist(az, el, d.norm());
    }
}
