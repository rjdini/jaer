...
/*
 * This class created in Telluride 2013 to encapsulate Bosch Sensortec BMI160 (6-axis IMU)
...
/**
 * Encapsulates data sent from device Bosch Sensortec BMI160 IMU. (acceleration x/y/z, temperature, gyro x/y/z => 7 x 2 bytes = 14
...
public class IMUSample {
     ...
     * gyro FS=±1000 °/s (32.8 LSB/(°/s)) and accel FS=±4 g (8192 LSB/g) for BMI160
     */
    private static float accelSensitivityScaleFactorGPerLsb = 1f / 8192,
            gyroSensitivityScaleFactorDegPerSecPerLsb = 1f / 32.8f, temperatureScaleFactorDegCPerLsb = 1f / 512f,
